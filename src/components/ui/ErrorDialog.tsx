      ...
      <DialogContent className=" h-[485px] max-w-md border-white/10  text-white">
        <div className=" absolute -z-10 w-full h-full">
          <div
            className="absolute -z-10 w-full h-full
                 bg-radial-[at_50%_0%] from-[#EE1D52]/80 to-[#EE1D52]/0 to-[50%]"
          />
          <Image
        ...
        <DialogHeader>
          <div className="relative flex justify-center items-center w-full h-[230px] ">
            ...
            <div className="mx-auto flex w-26 h-26 bg-failed-background rounded-full justify-center items-center">
              <div className="flex justify-center items-center  h-50 w-50">
                <div className="  flex justify-center items-center  h-20 w-20">
                  <Image
                    src="/icons/icon-failed-message.svg"
                    alt="Success"
                    width={64}
                    height={64}
                  />
